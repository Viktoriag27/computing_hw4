...
# df = load_data(file_path)  # Load the data from CSV
# print(df.head())  # Display the first 5 rows to ensure data is loaded correctly

# # Test clean_data function
# cleaned_df = clean_data(df)  # Clean and preprocess the data
# print(cleaned_df.head())  # Display the first 5 rows of the cleaned data to verify the changes

# # Test split_data function
# X_train, X_test, y_train, y_test = split_data(cleaned_df)  # Split the data

# # Check the shape of the datasets to ensure the split was done correctly
